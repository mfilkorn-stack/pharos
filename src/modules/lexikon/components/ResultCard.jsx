...
import { ChevronRightIcon, StarIcon, StarFilledIcon, PlusIcon } from "./ui/icons.jsx";
...
export default function ResultCard({ item, isActive, onOpen, isFavorite, onToggleFavorite, onAdd }) {
